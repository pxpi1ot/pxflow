	...
	return (
		<nav className="h-screen overflow-scroll justify-between flex items-center flex-col gap-10 py-6 px-2">
			<div className="flex items-center justify-center flex-col gap-4">
								...
								<TooltipTrigger>
									<li>
										<Link
											href={menuItem.href}
											className={clsx(
												"group flex items-center justify-center rounded-lg p-1  cursor-pointer",
												{
				...
				<Separator />
				<div className="flex items-center flex-col gap-9 dark:bg-[#353346]/30 py-4 px-1 rounded-full h-56 overflow-scroll border-[1px]">
